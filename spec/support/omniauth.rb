...
module OmniauthTestHelper
  ...
  def reset_twitter_mock_auth
    OmniAuth.config.mock_auth[:twitter] = nil
  end

  def set_default_twitter_mock_auth
    OmniAuth.config.mock_auth[:twitter] = OmniAuth::AuthHash.new(default_omniauth_auth_params)
  end

  def update_twitter_mock_auth(params = {})
    OmniAuth.config.add_mock(:twitter, params)
  end

  def default_omniauth_auth_params(params = {})
    {
      :provider => "twitter",
      :uid => "123456",
      :info => {
